...
class Bank
{
    ...
    public:
        ...
        void deal_chips_all_players(std::vector< std::pair<int, int> > chips); //change amount of chips at every player by amounts given in 'chips' (internally only banks 'money' is changed)
